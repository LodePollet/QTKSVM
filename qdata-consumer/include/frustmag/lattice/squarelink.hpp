...
struct squarelink : bravais<Site, 2ul, 2ul> {
...
template <typename Site>
struct serializer<frustmag::lattice::squarelink<Site>>
    : frustmag::lattice::serializer<frustmag::lattice::squarelink<Site>> {};
